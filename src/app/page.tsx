    ...
    <div className="min-h-screen bg-gradient-to-br from-[#FFFBF3] to-[#FFF8D2]">
      ...
      <main className="max-w-7xl mx-auto px-4 pt-0 pb-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-7xl mx-auto">
          ...
          <div className="rounded-2xl bg-gradient-to-br from-[#FFF6FB] to-[#FFEAF4] shadow-md shadow-[#EB89B5]/10 p-6 md:p-7 text-center min-h-[160px] flex flex-col items-center justify-center">
            <h3 className="font-serif text-xl md:text-2xl font-bold text-[#7A2454] leading-tight">
              Meet the students at Bonita Vista High School
            </h3>
            <p className="mt-3 text-sm font-semibold text-gray-700 tracking-[0.12em] uppercase">
              Coming soon
            </p>
          ...
          <div className="rounded-2xl bg-gradient-to-br from-[#FFF6FB] to-[#FFEAF4] shadow-md shadow-[#EB89B5]/10 p-6 md:p-7 text-center min-h-[160px] flex flex-col items-center justify-center">
            <h3 className="font-serif text-xl md:text-2xl font-bold text-[#7A2454] leading-tight">
              Meet the students at Woodward Academy
            </h3>
            <p className="mt-3 text-sm font-semibold text-gray-700 tracking-[0.12em] uppercase">
              Coming soon
            </p>
          ...
          <div className="rounded-2xl bg-gradient-to-br from-[#FFF6FB] to-[#FFEAF4] shadow-md shadow-[#EB89B5]/10 p-6 md:p-7 text-center min-h-[160px] flex flex-col items-center justify-center">
            <h3 className="font-serif text-xl md:text-2xl font-bold text-[#7A2454] leading-tight">
              Meet the students at Millard North High School
            </h3>
            <p className="mt-3 text-sm font-semibold text-gray-700 tracking-[0.12em] uppercase">
              Coming soon
            </p>
          ...
          <div className="rounded-2xl bg-gradient-to-br from-[#FFF6FB] to-[#FFEAF4] shadow-md shadow-[#EB89B5]/10 p-6 md:p-7 text-center min-h-[160px] flex flex-col items-center justify-center">
            <h3 className="font-serif text-xl md:text-2xl font-bold text-[#7A2454] leading-tight">
              Meet the students at Richard Montgomery High School
            </h3>
            <p className="mt-3 text-sm font-semibold text-gray-700 tracking-[0.12em] uppercase">
              Coming soon
            </p>
          ...
          <div className="rounded-2xl bg-gradient-to-br from-[#FFF6FB] to-[#FFEAF4] shadow-md shadow-[#EB89B5]/10 p-6 md:p-7 text-center min-h-[160px] flex flex-col items-center justify-center">
            <h3 className="font-serif text-xl md:text-2xl font-bold text-[#7A2454] leading-tight">
              Meet the students at Christian Brothers High School
            </h3>
            <p className="mt-3 text-sm font-semibold text-gray-700 tracking-[0.12em] uppercase">
              Coming soon
            </p>
          ...
          <div className="rounded-2xl bg-gradient-to-br from-[#FFF6FB] to-[#FFEAF4] shadow-md shadow-[#EB89B5]/10 p-6 md:p-7 text-center min-h-[160px] flex flex-col items-center justify-center">
            <h3 className="font-serif text-xl md:text-2xl font-bold text-[#7A2454] leading-tight">
              Meet the students at Harper Junior High School
            </h3>
            <p className="mt-3 text-sm font-semibold text-gray-700 tracking-[0.12em] uppercase">
              Coming soon
            </p>
          ...
          <div className="rounded-2xl bg-gradient-to-br from-[#FFF6FB] to-[#FFEAF4] shadow-md shadow-[#EB89B5]/10 p-6 md:p-7 text-center min-h-[160px] flex flex-col items-center justify-center">
            <h3 className="font-serif text-xl md:text-2xl font-bold text-[#7A2454] leading-tight">
              Meet the students at North Farmington High School
            </h3>
            <p className="mt-3 text-sm font-semibold text-gray-700 tracking-[0.12em] uppercase">
              Coming soon
            </p>
          ...
          <div className="rounded-2xl bg-gradient-to-br from-[#FFF6FB] to-[#FFEAF4] shadow-md shadow-[#EB89B5]/10 p-6 md:p-7 text-center min-h-[160px] flex flex-col items-center justify-center">
            <h3 className="font-serif text-xl md:text-2xl font-bold text-[#7A2454] leading-tight">
              Meet the students at Visions in Education
            </h3>
            <p className="mt-3 text-sm font-semibold text-gray-700 tracking-[0.12em] uppercase">
              Coming soon
            </p>
          ...
          <div className="rounded-2xl bg-gradient-to-br from-[#FFF6FB] to-[#FFEAF4] shadow-md shadow-[#EB89B5]/10 p-6 md:p-7 text-center min-h-[160px] flex flex-col items-center justify-center">
            <h3 className="font-serif text-xl md:text-2xl font-bold text-[#7A2454] leading-tight">
              Meet the students at Del Campo High School
            </h3>
            <p className="mt-3 text-sm font-semibold text-gray-700 tracking-[0.12em] uppercase">
              Coming soon
            </p>
          ...
          <div className="rounded-2xl bg-gradient-to-br from-[#FFF6FB] to-[#FFEAF4] shadow-md shadow-[#EB89B5]/10 p-6 md:p-7 text-center min-h-[160px] flex flex-col items-center justify-center">
            <h3 className="font-serif text-xl md:text-2xl font-bold text-[#7A2454] leading-tight">
              Meet the students at C.K. McClatchy High School
            </h3>
            <p className="mt-3 text-sm font-semibold text-gray-700 tracking-[0.12em] uppercase">
              Coming soon
            </p>
          ...
          <div className="rounded-2xl bg-gradient-to-br from-[#FFF6FB] to-[#FFEAF4] shadow-md shadow-[#EB89B5]/10 p-6 md:p-7 text-center min-h-[160px] flex flex-col items-center justify-center">
            <h3 className="font-serif text-xl md:text-2xl font-bold text-[#7A2454] leading-tight">
              Meet the students at Twelve Bridges High School
            </h3>
            <p className="mt-3 text-sm font-semibold text-gray-700 tracking-[0.12em] uppercase">
              Coming soon
            </p>
          ...
          <div className="rounded-2xl bg-gradient-to-br from-[#FFF6FB] to-[#FFEAF4] shadow-md shadow-[#EB89B5]/10 p-6 md:p-7 text-center min-h-[160px] flex flex-col items-center justify-center">
            <h3 className="font-serif text-xl md:text-2xl font-bold text-[#7A2454] leading-tight">
              Meet the students at Crean Lutheran High School
            </h3>
            <p className="mt-3 text-sm font-semibold text-gray-700 tracking-[0.12em] uppercase">
              Coming soon
            </p>
          ...
          <div className="rounded-2xl bg-gradient-to-br from-[#FFF6FB] to-[#FFEAF4] shadow-md shadow-[#EB89B5]/10 p-6 md:p-7 text-center min-h-[160px] flex flex-col items-center justify-center">
            <h3 className="font-serif text-xl md:text-2xl font-bold text-[#7A2454] leading-tight">
              Meet the students at Immanuel High School
            </h3>
            <p className="mt-3 text-sm font-semibold text-gray-700 tracking-[0.12em] uppercase">
              Coming soon
            </p>
          ...
          <div className="rounded-2xl bg-gradient-to-br from-[#FFF6FB] to-[#FFEAF4] shadow-md shadow-[#EB89B5]/10 p-6 md:p-7 text-center min-h-[160px] flex flex-col items-center justify-center">
            <h3 className="font-serif text-xl md:text-2xl font-bold text-[#7A2454] leading-tight">
              Meet the students at Ukiah High School
            </h3>
            <p className="mt-3 text-sm font-semibold text-gray-700 tracking-[0.12em] uppercase">
              Coming soon
            </p>
