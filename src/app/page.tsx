  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#FFFBF3] to-[#FFF8D2]">
      ...
      <main className="max-w-4xl mx-auto px-4 pt-0 pb-16">
        ...
        {/* Navigation Buttons */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-6 max-w-4xl mx-auto">
          {/* About Us Button */}
          <Link href="/about" className="group">
            <div className="bg-white rounded-lg shadow-lg p-3 md:p-6 text-center hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border-2 border-transparent hover:border-[#EB89B5]">
              <div className="w-10 h-10 md:w-14 md:h-14 bg-[#FFD7E9] rounded-full flex items-center justify-center mx-auto mb-2 md:mb-3 group-hover:bg-[#EB89B5] transition-colors">
                <svg className="w-5 h-5 md:w-7 md:h-7 text-[#EB89B5] group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z" />
                </svg>
              </div>
              <h3 className="text-xs md:text-lg font-bold text-gray-800 mb-1 md:mb-2">About Us</h3>
              <p className="text-[10px] md:text-sm text-gray-600 group-hover:text-gray-700 leading-tight">
          ...
          <Link href="/events" className="group">
            <div className="bg-white rounded-lg shadow-lg p-3 md:p-6 text-center hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border-2 border-transparent hover:border-[#EB89B5]">
              ...
              <h3 className="text-xs md:text-lg font-bold text-gray-800 mb-1 md:mb-2">Upcoming Events</h3>
              <p className="text-[10px] md:text-sm text-gray-600 group-hover:text-gray-700 leading-tight">
          ...
          <Link href="/involved" className="group">
            <div className="bg-white rounded-lg shadow-lg p-3 md:p-6 text-center hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border-2 border-transparent hover:border-[#EB89B5]">
              ...
              <h3 className="text-xs md:text-lg font-bold text-gray-800 mb-1 md:mb-2">Get Involved</h3>
              <p className="text-[10px] md:text-sm text-gray-600 group-hover:text-gray-700 leading-tight">
          ...
          <Link href="/media" className="group">
            <div className="bg-white rounded-lg shadow-lg p-3 md:p-6 text-center hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border-2 border-transparent hover:border-[#EB89B5]">
              ...
              <h3 className="text-xs md:text-lg font-bold text-gray-800 mb-1 md:mb-2">Media Coverage</h3>
              <p className="text-[10px] md:text-sm text-gray-600 group-hover:text-gray-700 leading-tight">
